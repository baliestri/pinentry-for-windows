...
internal sealed class SetNotOkButtonCommandHandler : CommandHandler {
  /// <inheritdoc />
  public override string Name => "SETNOTOK";
  ...
  public override async Task HandleAsync(IReadOnlyAssuanCommand command, IServerContext serverContext) {
    ...
    SessionState.NotOkButtonText = command.AsText().Replace('_', '&');
